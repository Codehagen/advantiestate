...
seoTitle: "Markedspuls Nord-Norge 2025/2026"
...
image: /building/pexels-high-rise-clear-sky-32485809.jpg
author: codehagen
categories:
  - market-analysis
related:
...
<Figure n="Fig. 01" caption="Kontormarkedet i Nord-Norge går inn i 2026 med lav ledighet og stabil etterspørsel, særlig i Bodø og Tromsø.">
  <Image src="/building/pexels-grayscale-high-rise-14387919.jpg" alt="Kontorbygg som illustrerer næringseiendomsmarkedet i Nord-Norge" width={1200} height={675} />
</Figure>

<StatStrip
  items={[
    { value: "5,80", unit: "%", label: "Prime yield Bodø" },
    { value: "5,50", unit: "%", label: "Prime yield Tromsø" },
    { value: "~103", unit: "mrd. NOK", label: "Transaksjoner Norge 2025E" },
    { value: "4,00", unit: "%", label: "Styringsrente" },
  ]}
/>
...
<Summary
  title="Nøkkeltall Bodø · Q4 2025."
  points={[
    { title: "Ledig areal", description: "45 200 m² nærings-, kontor- og industriareal." },
    { title: "Antall bygg med ledig areal", description: "60 bygg, en blanding av offentlig og privat eierskap." },
    { title: "Ledighet", description: "3,1 % – godt under grensen for et stramt marked (<5 %)." },
    { title: "Endring siste periode", description: "+6 000 m², altså en svak økning." },
    { title: "Dominerende type", description: "Eksisterende bygg, ikke nybygg." },
  ]}
/>
...
<Summary
  title="Nøkkeltall Tromsø · Q4 2025."
  points={[
    { title: "Ledighet", description: "2,5 % – ekstremt lavt, nesten fullt utleid." },
    { title: "Trend", description: "Nedgang i ledig areal." },
    { title: "Boligprisvekst 2025", description: "+10,7 %, et tegn på sterk underliggende vekst." },
    { title: "Vekstdrivere", description: "Turisme, forskning, energi og offentlig sektor." },
  ]}
/>
...
<Note variant="key">
Kombinasjonen av rekordlav ledighet (2,5 % i Tromsø, 3,1 % i Bodø) og forventede rentekutt mot ~3,5 % ved utgangen av 2026 peker mot moderat yield‑kompresjon og økt transaksjonsvolum i Nord-Norge.
</Note>
...
<Summary
  title="Markedsdrivere Nord-Norge."
  points={[
    { title: "Bodø ny flyplass", description: "Ny lufthavn styrker tilgjengeligheten og attraktiviteten for nasjonale og internasjonale aktører." },
    { title: "Tromsø befolkningsvekst", description: "Sterk vekst innen turisme, forskning, energi og offentlig sektor driver etterspørselen etter næringsareal." },
    { title: "Rentekutt", description: "Lavere renter gir bedre finansieringsvilkår og lavere avkastningskrav, noe som støtter eiendomsverdier." },
    { title: "Begrenset nybygging", description: "Lav nybygging holder ledigheten nede og støtter leieprisutviklingen." },
    { title: "Industriutvikling", description: "Industriprosjekter skaper ringvirkninger for næringseiendommer." },
  ]}
/>
