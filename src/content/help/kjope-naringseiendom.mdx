...
## Hele transaksjonen, steg for steg

Kjøpsprosessen vi har skissert over henger sammen med en rekke mer spesialiserte temaer. Står du på den andre siden av bordet, er det nyttig å forstå hvordan det er å [selge næringseiendom](/help/article/selge-naringseiendom), hvordan du [leser et salgsprospekt](/help/article/salgsprospekt-naringseiendom) kritisk, og hvordan en [intensjonsavtale (LOI)](/help/article/intensjonsavtale-loi) og selve [budprosessen](/help/article/budgivning-naringseiendom) fastlegger pris og struktur før du binder deg.

Når intensjonsavtalen er på plass, flytter tyngdepunktet seg til gjennomgangen. Her åpnes [datarommet](/help/article/datarom-eiendomstransaksjon), og du gjennomfører [teknisk due diligence](/help/article/teknisk-due-diligence), [juridisk og finansiell due diligence](/help/article/juridisk-finansiell-due-diligence) og en vurdering av [grunnforurensning og miljø](/help/article/grunnforurensning-naringseiendom). Funnene former de endelige avtalevilkårene, enten kjøpet skjer via [aksjekjøpsavtalen (SPA)](/help/article/spa-aksjekjopsavtale) eller etter [meglerstandarden](/help/article/meglerstandard-naringseiendom).

Til slutt kommer formalitetene og økonomien: [heftelser, tinglysing og oppgjør](/help/article/heftelser-tinglysing-oppgjor), [dokumentavgift](/help/article/dokumentavgift-naringseiendom), [meglerhonorar og oppdragsavtale](/help/article/meglerhonorar-oppdragsavtale), og det grunnleggende valget om du skal [eie privat eller gjennom AS](/help/article/eie-privat-eller-as).
