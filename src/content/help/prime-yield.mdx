...
categories:
  - analysis
takeaways:
  - Prime yield er avkastningskravet for den best kvalifiserte eiendommen og fungerer som markedets referansepunkt for all prising.
  - Fire kriterier kjennetegner en prime-eiendom — sentral beliggenhet, høy bygningskvalitet, lang gjenværende kontraktstid og solid leietaker.
  - Yield-spread mot sekundæreiendom er et barometer på markedets risikoappetitt; smalt spread betyr høy risikovilje, bredt spread mer selektive investorer.
  - I verdivurdering og DCF er prime yield ankerpunktet du justerer opp fra basert på eiendommens individuelle risikoprofil.
related:
  - hva-er-yield
  - exit-yield
...
Når du leser en markedsrapport eller skal prise en næringseiendom, dukker prime yield opp som tallet alt annet måles mot. Forstår du hva prime betyr, og hvordan yield-spreaden mot sekundæreiendom beveger seg, leser du markedet langt mer presist.

<Prerequisites>
  - Grunnleggende forståelse av [yield](/help/article/hva-er-yield) i næringseiendom
  - Kjennskap til [yield-gap](/help/article/yield-gap) mot alternative plasseringer
  - Forståelse av [exit yield](/help/article/exit-yield) i DCF-analyser
...
<Compare
  pro={{
    head: "Prime-eiendom (referansepunktet)",
    items: [
      "Sentral beliggenhet i det mest etterspurte delmarkedet",
      "Høy teknisk standard og fleksible planløsninger",
      "Lang gjenværende kontraktstid og forutsigbar kontantstrøm",
      "Solid leietaker med høy kredittverdighet",
      "Lavest yield i markedet — grunnlinjen alt annet måles mot"
    ]
  }}
  con={{
    head: "Sekundæreiendom (prises med påslag)",
    items: [
      "Svakere på ett eller flere prime-kriterier",
      "Kortere eller mer usikker gjenværende kontraktstid",
      "Lavere teknisk standard eller beliggenhet i randsonen",
      "Mindre eller mer usikker leietaker",
      "Høyere avkastningskrav — et risikopåslag ut fra prime"
    ]
  }}
/>
  ...
  items={[
    {
      ...
      pre: "Kunnskap",
      title: "Yield-gap — eiendom mot alternative plasseringer",
    },
    {
      href: "/help/article/hvordan-lese-markedsrapport",
      pre: "Kunnskap",
      title: "Slik leser du en markedsrapport for næringseiendom",
    },
    {
