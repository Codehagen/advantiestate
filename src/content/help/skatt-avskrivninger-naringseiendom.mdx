...
categories:
  - for-investors
takeaways:
  - "Saldoavskrivning er degressiv: høyest fradrag tidlig i eierperioden, lavere etter hvert som saldoverdien faller."
  - Tomt kan ikke avskrives — bare bygningsdelen og faste tekniske installasjoner gir skattefradrag.
  - Avskrivninger er ikke en kontantutgift, men reduserer skattbart overskudd og bedrer kontantstrøm etter skatt.
  - Latent skatt vokser når saldoverdien faller under markedsverdi — sentralt ved transaksjoner.
related:
...
Dette skillet er praktisk viktig ved kjøp. Dersom en eiendom er kjøpt til en samlet sum, må kjøpesummen fordeles mellom de tre komponentene:

<Summary
  title="Fordeling av kjøpesummen"
  points={[
    {
      title: "Tomt",
      description: "Ingen avskrivning — tomteverdi er ikke et saldodriftsmiddel og gir ingen fradragsrett.",
      iconName: "scales"
    },
    {
      title: "Bygningsdelen",
      description: "Avskrives i sin saldogruppe.",
      iconName: "barChart"
    },
    {
      title: "Fast teknisk installasjon",
      description: "Avskrives i en separat, gunstigere saldogruppe.",
      iconName: "lineChart"
    }
  ]}
/>
...
## Skattemotoren i det norske markedet

Avskrivninger er bare én brikke i et større skattebilde som avgjør hva en eiendomsinvestering faktisk gir etter skatt. Når eiendom selges, kommer strukturen i forgrunnen: [fritaksmetoden](/help/article/fritaksmetoden-eiendom) forklarer hvorfor eiendom oftest omsettes som aksjer, mens [latent skatt og skatterabatt](/help/article/latent-skatt-skatterabatt) viser hvordan den utsatte skatteforpliktelsen prises inn i kjøpesummen. For å få en eiendom inn i et eget selskap før transaksjon brukes ofte [fisjon før salg](/help/article/fisjon-for-salg), og ved direkte salg av selve eiendommen er det reglene om [gevinstbeskatning ved salg](/help/article/gevinstbeskatning-salg) som styrer skatten.

Den løpende driften har sitt eget regelverk. [MVA på næringseiendom](/help/article/mva-pa-naringseiendom) avgjør om utleien er avgiftspliktig, og [frivillig registrering for MVA](/help/article/frivillig-registrering-mva) er nøkkelen til fradrag for inngående merverdiavgift. Ved ombygging og endret bruk slår [justeringsreglene](/help/article/justeringsregler-mva) inn, mens [eiendomsskatt](/help/article/eiendomsskatt-naringseiendom) er en kommunal kostnad som varierer betydelig fra sted til sted. Til sammen utgjør disse temaene skattemotoren du må forstå for å regne riktig på næringseiendom.
...
<ReadMore
  items={[
    ...
    },
    {
      ...
      pre: "Kunnskap",
      title: "Kontantstrømsanalyse — slik modellerer du etter skatt",
    },
      {
        href: "/help/article/fritaksmetoden-eiendom",
        pre: "Kunnskap",
        title: "Fritaksmetoden — derfor selges eiendom som aksjer",
      },
      {
        href: "/help/article/mva-pa-naringseiendom",
        pre: "Kunnskap",
        title: "MVA på næringseiendom — registrering og fradrag",
      },
      {
        href: "/help/article/gevinstbeskatning-salg",
        pre: "Kunnskap",
        title: "Gevinstbeskatning ved salg av næringseiendom",
      },
    {
