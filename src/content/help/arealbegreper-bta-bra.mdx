...
categories:
  - terms
takeaways:
  - BTA, BRA og utleibart areal gir tre ulike kvadratmetertall for samme bygg.
  - Fellesarealpåslaget («load factor») gjør at leietaker betaler for mer areal enn det de disponerer eksklusivt.
  - Leie per kvm er meningsløst å sammenligne uten å vite hvilket arealbegrep som er brukt.
  - Arealtall i prospekter bør alltid verifiseres mot tegninger og eventuelt ved ettermåling.
related:
...
Samme næringsbygg kan måles på flere måter, og hver målemetode gir et annet kvadratmetertall. Det betyr at en leie oppgitt «per kvm» kan bety vidt forskjellige ting fra eiendom til eiendom. Forstår du arealbegrepene, forstår du hva du faktisk betaler for — og hva du faktisk får leid ut.

<Prerequisites>
  - Grunnleggende forståelse av [markedsleie og leienivå](/help/article/markedsleie-og-leieniva)
...
Arealbegreper i næringseiendom beskriver ulike måter å måle og oppgi kvadratmeter på. Samme bygg kan ha svært ulike arealtall avhengig av hvilket begrep man bruker — og det betyr at leie per kvm er meningsløst uten å vite hvilket arealbegrep som ligger til grunn.
  ...
  items={[
    {
      ...
      pre: "Kunnskap",
      title: "Markedsleie og leienivå — slik vurderes leien",
    },
    {
      ...
      {
        href: "/help/article/fellesarealfaktor",
        pre: "Kunnskap",
        title: "Fellesarealfaktor og påslag i næringsleie",
      },
      {
        href: "/help/article/utnyttelsesgrad-bya-bra-tomt",
        pre: "Kunnskap",
        title: "Utnyttelsesgrad (BYA og %-BRA) på tomt",
      },
    {
