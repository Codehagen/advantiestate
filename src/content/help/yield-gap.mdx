...
categories:
  - terms
takeaways:
  - "Yield gap er eiendomsyield minus risikofri rente — risikopremien investorer krever for å bære eiendomsrisiko fremfor en sikker renteplassering."
  - "Et smalt yield gap betyr at eiendom er priset nær rentemarkedet, og verdiene er da mer utsatt for fall ved renteoppgang."
  - "Når renten stiger, følger eiendomsyield vanligvis etter — og siden yield og verdi er inverse, presses eiendomsverdiene ned."
  - "Bruk yield gap som bakteppe, men kombiner alltid med kontrakts- og leietakervurdering og en sensitivitetsanalyse."
related:
  - hva-er-yield
  - exit-yield
...
En eiendomsinvestor velger alltid mellom å plassere kapital i eiendom eller i et rentebærende alternativ uten risiko. Yield gap er tallet som sier hvor godt eiendom betaler for risikoen den ekstra plasseringen innebærer — og det er en av de viktigste indikatorene for om prisnivået i eiendomsmarkedet er bærekraftig i et renteperspektiv.

<Prerequisites>
  - Forståelse av [yield](/help/article/hva-er-yield) i næringseiendom
  - Kjennskap til [prime yield](/help/article/prime-yield) som markedsreferanse
  - Hva [exit yield](/help/article/exit-yield) er og hvorfor den betyr noe
</Prerequisites>

## Hva er yield gap?

**Yield gap** er differansen mellom [eiendomsyield](/help/article/hva-er-yield) og en risikofri referanserente — typisk en statsobligasjonsrente eller en swap-rente med løpetid tilsvarende en typisk leiekontrakt. Gapet er en direkte målestokk på den risikopremien markedet setter på eiendomsinvesteringer relativt til rentebærende instrumenter uten kreditrisiko.
...
<Example
  title="Verdifall når yield stiger ett prosentpoeng"
  steps={[
    {
      label: "Netto leieinntekt (NOI)",
      value: 5000000,
      calculation: "Utgangspunkt for begge beregninger"
    },
    {
      label: "Verdi ved yield 4,0 %",
      value: 125000000,
      calculation: "5 000 000 / 0,040"
    },
    {
    ...
    },
    {
      ...
      value: "-20 %",
      calculation: "Ett prosentpoeng høyere yield gir 20 % lavere verdi",
      isResult: true
    }
  ]}
/>
...
Yield gap er et nyttig bakteppebegrep for vurdering av eiendomsinvesteringer i et renteperspektiv. Det gir svar på tre spørsmål en investor bør stille før en handel.

<Summary
  title="Tre spørsmål yield gap besvarer"
  points={[
    {
      title: "Er eiendom priset rimelig?",
      description: "Et historisk lavt yield gap kan indikere at investorer godtar lav risikopremie relativt til alternativene.",
      iconName: "scales"
    },
    {
      title: "Hva er rentesensitiviteten?",
      description: "Eiendommer med smalt yield gap og lav absolutt yield er mest utsatt ved renteoppgang.",
      iconName: "lineChart"
    },
    {
      title: "Hva er bufferkapasiteten?",
      description: "Et bredt yield gap gir rom for at rentene kan stige noe uten at eiendom umiddelbart blir uattraktivt priset.",
      iconName: "barChart"
    }
  ]}
/>
...
<ReadMore
  items={[
    ...
    },
    {
      ...
      pre: "Kunnskap",
      title: "Exit yield — hvorfor sluttyield avgjør verdien",
    },
    {
