        ...
        <div className="border-b border-warm-grey-1/20 bg-gradient-to-br from-light-blue/10 to-warm-white px-6 py-6 dark:border-warm-grey-2/20 dark:from-light-blue/5 dark:to-warm-grey">
          ...
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-light-blue/20 p-3">
              <RiRoadMapLine className="h-6 w-6 text-warm-grey dark:text-warm-white" />
            </div>
            <div>
              ...
              <p className="mt-1 text-sm text-warm-grey-2 dark:text-warm-grey-1">
                Vi hjelper deg med strategisk rådgivning for din eiendomsportefølje
              </p>
            </div>
          </div>
        </div>
        ...
        {isSuccess ? (
          <div className="flex flex-col items-center justify-center px-6 py-12">
            ...
            <p className="mt-2 text-center text-warm-grey-2 dark:text-warm-grey-1">
              Vi vil kontakte deg innen 24 timer for å avtale en strategisessjon.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="px-6 py-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input id="company" name="company" type="text" placeholder="Ditt selskap" required />
              </div>
              <div>
                <label htmlFor="challenge" className="mb-2 block text-sm font-medium text-warm-grey dark:text-warm-white">
                ...
                <textarea
                  ...
                  placeholder="Beskriv den største utfordringen du står overfor..."
                />
              </div>
              <div>
                <label htmlFor="goals" className="mb-2 block text-sm font-medium text-warm-grey dark:text-warm-white">
              ...
              <div>
                <label htmlFor="timeline" className="mb-2 block text-sm font-medium text-warm-grey dark:text-warm-white">
                  Ønsket tidsramme
                </label>
                <Input id="timeline" name="timeline" type="text" placeholder="f.eks. Innen Q2 2025" />
              </div>
            </div>
            <div className="mt-6">
