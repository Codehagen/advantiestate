        ...
        <div className="border-b border-warm-grey-1/20 bg-gradient-to-br from-light-blue/10 to-warm-white px-6 py-6">
          ...
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-light-blue/20 p-3">
              <RiRoadMapLine className="h-6 w-6 text-warm-grey" />
            </div>
            <div>
        ...
        {isSuccess ? (
          ...
          <form onSubmit={handleSubmit} onFocusCapture={onFirstFocus} className="px-6 py-6">
            <div className="space-y-4">
              ...
              <div>
                <label htmlFor="challenge" className="mb-2 block text-sm font-medium text-warm-grey">
              ...
              <div>
                <label htmlFor="goals" className="mb-2 block text-sm font-medium text-warm-grey">
              ...
              <div>
                <label htmlFor="timeline" className="mb-2 block text-sm font-medium text-warm-grey">
                  Ønsket tidsramme
                </label>
