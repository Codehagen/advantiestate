  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl p-6 pt-16">
        <div className="[&>*]:text-warm-grey/60 [&>*]:group-hover:text-warm-grey/80">
          {icon}
        </div>
        <h3 className="mt-4 font-semibold leading-7 text-warm-grey">
          <Link href={href}>
            <span className="absolute inset-0 rounded-2xl" />
            {name}
          </Link>
        </h3>
        <p className="mt-1 text-sm text-warm-grey/80">{description}</p>
      </div>
    </div>
  )
}
