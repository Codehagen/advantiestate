...
export default function HelpArticleLink({ article }: HelpArticleLinkProps) {
  ...
  return (
    ...
    >
      <h3 className="text-sm font-medium text-warm-grey/80 group-hover:text-warm-grey sm:text-base dark:text-warm-white/80 dark:group-hover:text-warm-white">
        {article.title || "Untitled Article"}
      </h3>
      <ExpandingArrow className="-ml-4 h-4 w-4 text-warm-grey/60 group-hover:text-warm-grey/80 dark:text-warm-white/60 dark:group-hover:text-warm-white/80" />
    </Link>
  )
}
