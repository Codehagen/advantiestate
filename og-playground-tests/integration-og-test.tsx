...
// Test with different integration providers

export default function IntegrationOG() {
  // TEST PARAMETERS - Modify these to test different scenarios
  const title = "Ambita Eiendomsdata API"
  const description = "Integrasjon med Ambita for sanntids eiendomsinformasjon, historiske transaksjoner og markedsanalyse for næringseiendom i Norge."
  const provider = "Ambita"
  const category = "eiendom" // Options: finansiering, marked, eiendom, regnskap, general
