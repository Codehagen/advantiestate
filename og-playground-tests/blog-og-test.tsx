...
export default function BlogOG() {
  ...
  const title = "Hvordan verdsette næringseiendom i 2025: En komplett guide"
  const author = "Christer Hagen"
  const category = "valuation" // Options: company, valuation, market-analysis, casestudies
  const date = "2025-01-15"
  const summary = "En grundig gjennomgang av de viktigste metodene for verdivurdering av næringseiendom, inkludert DCF-analyse og avkastningskrav."
