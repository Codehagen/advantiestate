...
export default function ServiceOG() {
  // TEST PARAMETERS - Modify these to test different scenarios
  const title = "Verdivurdering av Næringseiendom"
  const description = "Profesjonell verdivurdering basert på DCF-analyse og markedsdata. Vi sikrer nøyaktige vurderinger for kjøp, salg og finansiering."
  const icon = "📊" // Change this: 🏢 💼 📊 🔑 📈 💰
  const serviceType = "verdsettelse" // Options: salg, verdsettelse, leietakere, transaksjoner, regnskap, general
